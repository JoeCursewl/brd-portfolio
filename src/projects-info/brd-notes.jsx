...
export default function Projects() {
    ...
    const bitter_id = {
        ...
        "p_name": "Bitter",
        "date_repo": "05/23",
        "description_repo": "Bitter is an app where anyone can share anything, simply. Jot down poems, thoughts, or anything else want to share with friends or the world. People can express themselves visually with images. Save their creations and share them with friends or the world using a unique link.",
