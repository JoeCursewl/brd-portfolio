            ...
            <div className="w-[85%] flex justify-center items-center sm:w-[75%]">
                ...
                <div className='my-2 flex justify-start items-start flex-col w-full'>
                    ...
                    <div className='grid gap-4'>
                        ...
                        <p>
                            I'm based in <span className='spn-dvp'>Táchira, Venezuela</span>, and I'm 20 years old. I'm currently studying the college to become a system engineer. My goal is being able to improve myself in this aspect everyday if I can, and <span className='spn-ant'>try to do my best</span> as much as I can.
                        </p>
