            ...
            <div className="w-[85%] flex justify-center items-center sm:w-[75%]">
                ...
                <div className='my-2 flex justify-start items-start flex-col w-full'>
                    ...
                    <div className='grid gap-4'>
                        <p>Hi there! 👋. As I said I'm <span className='spn-dvp'>Anthony Zerpa</span>, a highly motivated <span className='spn-ant'>Frontend & Backend</span> developer with a passion for developing new stuff. I bring 2 years of experience to the table, and I'm always eager to learn and grow. I'm particularly interested in Web development. In my free time, you might find me producing music and probably designing. Let's connect and discuss how I can contribute to your team!</p>
                        <p>
                        ...
                        <p>In my <span className='spn-ant'>free time</span>, I like to make beats and design everything that comes up to me in that moment. I enjoy creating new things and getting better everyday. I'm willing to <span className='spn-ant'>keep learning</span> any technology if needed, that's my goal
                            to keep <span className='spn-dvp'>being useful.</span></p>

                        <div className='border-t border-solid border-[#ffc5c513] pt-4'>
                            <p className='text-[#ffa5a5] text-[1.1rem]'>Contact information 👇🏻</p>
                        </div>
